def generate_col_peripherals(filename="col_peripherals.sp"):
    with open(filename, "w") as f:
        ...
        f.write("Mn_w1 BLB WEN node1 GND nmos_sram m=2\n")
        f.write("Mn_w2 node1 D_in GND GND nmos_sram m=2\n")
        f.write("Mn_w3 BL WEN node2 GND nmos_sram m=2\n")
        f.write("Mn_w4 node2 D_in_b GND GND nmos_sram m=2\n")
        f.write(".ends\n\n")
